...
public interface FxRateJpaRepository extends JpaRepository<FxRateJpaEntity, String> {
    ...
    List<FxRateJpaEntity> findAllByOrderByEffectiveDateDescBaseCurrencyAscQuoteCurrencyAsc();

    Optional<FxRateJpaEntity> findFirstByBaseCurrencyAndQuoteCurrencyAndEffectiveDateLessThanEqualOrderByEffectiveDateDesc(
